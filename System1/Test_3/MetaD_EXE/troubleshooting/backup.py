...
if __name__ == '__main__':
    ...
    for i in range(20):
        ...
        f = open(f'rep_{i + 1}/block_analysis_result_truncate_{frac}.txt', 'r')
        lines = f.readlines()
        f.close()
    ...
    plt.ylim([-2, -5.2])
    plt.legend(ncol=4)
    plt.savefig('delta_f_20_reps_truncate_{frac}.png', dpi=600)
    ...
    plt.legend(ncol=4)
    plt.savefig('delta_f_err_20_reps_truncate_{frac}.png', png=600)
    ...
    for i in range(20):
        ...
        plt.legend(ncol=2)
    plt.savefig('delta_f_distribution_20_reps_truncate_{frac}.png', png=600)
