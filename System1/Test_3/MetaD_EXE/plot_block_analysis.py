...
if __name__ == '__main__':
    ...
    plt.ylim([-2, -5.2])
    plt.legend(ncol=4)
    plt.savefig('delta_f_20_reps_no_truncation.png', dpi=600)
    ...
    plt.legend(ncol=4)
    plt.savefig('delta_f_err_20_reps_no_truncation.png', png=600)
    ...
    for i in range(20):
        ...
        plt.legend(ncol=2)
    plt.savefig('delta_f_distribution_20_reps_no_truncation.png', png=600)
