...
if __name__ == "__main__":
    ...
    for folder in args.dir:
        ...
        if len(n_blocks) == 1:
            result_file = folder + \
                f'fes_1d_results_truncate_{truncate}_nblocks_{n_blocks[0]}_avg_{avg_frac}.txt'
        elif len(n_blocks) > 1:
            result_file = folder + \
                f'fes_1d_results_truncate_{truncate}_nblocks_multi_avg_{avg_frac}.txt'
        ...
        traj = traj[~((traj['d'] > 0.45803763) & (traj['lambda']==0))]
