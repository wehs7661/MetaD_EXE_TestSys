...
def average_bias(hills, avg_frac):
    ...
    """
    hills_unphysical = pd.concat([hills[hills.n.gt(10.5)], hills[hills.n.lt(0.7)]])
    hills_physical = hills[hills.n.between(0.7, 10.5)]
    ...
    n_list.append(len(hills[hills.n.gt(10.5)]))   # number of points with N > 10
...
if __name__ == "__main__":
    ...
    for folder in args.dir:
        ...
        L.logger(f'- Number of points in the unphysical region (N > 10.5): {n_list[1]} ({n_list[1] / n_list[0] * 100:.2f}%)')
        # L.logger(f'    - Number of points with N > 10.5: {n_list[1]} ({n_list[1] / n_list[0] * 100:.2f}%)')
        # L.logger(f'    - Number of points with N < 1: {n_list[2]} ({n_list[2] / n_list[0] * 100:.2f}%)')
        L.logger(f'- Number of points in the physical region (N <= 10.5): {n_list[0] - n_list[1]} ({100 - n_list[1] / n_list[0] * 100:.2f}%)')
