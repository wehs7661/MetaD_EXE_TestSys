...
if __name__ == '__main__':
    ...
    start = 18000    # 36000 Gaussians, 18 ns
    step = 2         # output a file for every 4 Gaussians (2 ps, same as nstlog)
    ...
    for i in track(range(1001)):    # 100 * 500 = 50000 Gaussians, 1 ns
        t = (start + step * i) * 1  # 1 = PACE * dt
    ...
    fes_series = np.array([data[i][1] for i in range(1001)])
