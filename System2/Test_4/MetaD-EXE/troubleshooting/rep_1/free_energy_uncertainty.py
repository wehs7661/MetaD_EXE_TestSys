...
def get_CV_indices(x, g_min, dx):
    """
    This function returns the indices of the grids given the values of multidimensional CV. For example, (CV1, CV2, CV3) = (3.89, 4.21, -0.34)might correspond to a index tuple like (2, 3, 10). This is the inverse function of get_CV_indices.
