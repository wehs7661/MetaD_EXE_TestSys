...
if __name__ == '__main__':
    t1 = time.time()
    trajs = ['MetaD_min_0/sys2.xtc', 'MetaD_min_1/sys2.xtc']
    top = 'MetaD_min_0/sys2.top'
    ...
    plot_all_distributions('angle', 'Sys2_remodified_theta_MetaD_angle_distributions.png')
    plot_all_distributions('dihedral', 'Sys2_remodified_theta_MetaD_dihedral_distributions.png')
