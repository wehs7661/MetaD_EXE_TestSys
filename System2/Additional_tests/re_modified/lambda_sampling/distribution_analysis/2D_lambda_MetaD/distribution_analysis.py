...
if __name__ == '__main__':
    t1 = time.time()
    trajs = ['../../state_A/lambda_MetaD/2D_simulation/rep_1/sys2.xtc', '../../state_B/lambda_MetaD/2D_simulation/rep_1/sys2.xtc']
    top = '../../state_A/lambda_MetaD/2D_simulation/rep_1/sys2.top'
    ...
    plot_all_distributions('angle', 'Sys2_remodified_2D_lambda_angle_distributions.png')
    plot_all_distributions('dihedral', 'Sys2_remodified_2D_lambda_dihedral_distributions.png')
