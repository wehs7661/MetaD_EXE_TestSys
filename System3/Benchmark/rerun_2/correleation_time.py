...
if __name__ == '__main__':
    ...
    args = initialize()
    data = np.transpose(np.loadtxt('water_0.35.dat'))
    time, n = data[0] / 1000 * 2, data[1]  # units of time: ns
    ...
    plt.plot(time, n)
    plt.xlabel('Time (ns)')
    plt.ylabel('The number of water molecuels')
    plt.grid()
    plt.savefig('sys3_EXE_water_0.35.png')
